...
export const translations = {
  en: {
    ...
    Validation: {
      ...
      selectContractMonths: 'Select a valid duration',
      reasonRequired: 'Please provide a reason (min 10 chars)',
      passwordMin: 'Password must be at least 8 characters',
      passwordPattern: 'Password must include uppercase, lowercase, number and symbol',
      passwordsDontMatch: 'Passwords do not match',
      humanCheck: 'Please solve the puzzle',
      humanCheckError: 'Incorrect answer',
      ...
      passwordSpecial: 'At least one symbol (@$!%*?&)',
    },
    Table: {
      actions: 'Actions',
  ...
  es: {
    ...
    Validation: {
      ...
      selectContractMonths: 'Seleccione una duración válida',
      reasonRequired: 'Indique el motivo (mín. 10 caracteres)',
      passwordMin: 'Mínimo 8 caracteres',
      passwordPattern: 'Debe incluir mayúsculas, minúsculas, números y símbolos',
      passwordsDontMatch: 'Las contraseñas no coinciden',
      humanCheck: 'Resuelve el acertijo',
      humanCheckError: 'Respuesta incorrecta',
      ...
      passwordSpecial: 'Al menos un símbolo (@$!%*?&)',
    },
    Table: {
      actions: 'Acciones',
